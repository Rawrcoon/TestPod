...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sören Busch"
  # s.authors            = { "Sören Busch" => "sbusch@mobivention.com" }
  # s.social_media_url   = "http://twitter.com/Sören Busch"
  ...
  s.source       = { :git => "http://EXAMPLE/TestPod.git", :tag => "0.0.1" }
